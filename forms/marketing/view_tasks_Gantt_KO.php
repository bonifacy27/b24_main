...
$APPLICATION->SetTitle('Диаграмма Ганта: задачи креативного отдела (КО)');
...
$eventType = 'MARKETING_GANTT_KO_VISIT';
...
if ($currentUserId > 0 && !in_array($currentUserId, $skipLoggingUserIds, true)) {
    CEventLog::Add([
        ...
        'MODULE_ID' => 'main',
        'ITEM_ID' => 'forms/marketing/view_tasks_Gantt_KO.php',
...
<?php if (in_array($currentUserId, $statsViewerUserIds, true)): ?>
    ...
    $itemSql = $DB->ForSql('forms/marketing/view_tasks_Gantt_KO.php');

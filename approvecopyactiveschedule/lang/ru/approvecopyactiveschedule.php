...
$MESS ['BPAA_ACT_BUTTON3'] = "Доработать";
$MESS['BPAA_ACT_REFINE_TRACK'] = "Пользователь #PERSON# отправил на доработку документ #COMMENT#";
$MESS['BPAA_DESCR_REFINE_ALLOWED'] = 'С возможностью доработки';
$MESS['BPAR_PD_REFINE_ALLOWED'] = 'С возможностью доработки';
?>
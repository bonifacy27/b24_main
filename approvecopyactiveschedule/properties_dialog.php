...
<tr>
	<td align="right" width="40%"><?= GetMessage("BPAA_NOTIFY_SUBJECT") ?>:</td>
	<td width="60%"><input type="text" name="notify_subject" value="<?= htmlspecialcharsbx($arCurrentValues["notify_subject"]) ?>" size="50" /></td>
</tr>
<tr>
...
<tr>
	...
	<td width="60%"><input type="text" name="rem1_hours" value="<?= htmlspecialcharsbx($arCurrentValues["rem1_hours"]) ?>" size="10" /></td>
</tr>
<tr>
	<td align="right" width="40%"><?= GetMessage("BPAA_NOTIFY_SUBJECT") ?> 1:</td>
	<td width="60%"><input type="text" name="rem1_subject" value="<?= htmlspecialcharsbx($arCurrentValues["rem1_subject"]) ?>" size="50" /></td>
</tr>
<tr>
	<td align="right" width="40%"><?= GetMessage("BPAA_NOTIFY_TEXT") ?> 1:</td>
	<td width="60%"><textarea name="rem1_text" rows="3" cols="50"><?= htmlspecialcharsbx($arCurrentValues["rem1_text"]) ?></textarea></td>
</tr>
<tr>
	<td align="right" width="40%">Напоминание 2 (часов):</td>
	<td width="60%"><input type="text" name="rem2_hours" value="<?= htmlspecialcharsbx($arCurrentValues["rem2_hours"]) ?>" size="10" /></td>
</tr>
<tr>
	<td align="right" width="40%"><?= GetMessage("BPAA_NOTIFY_SUBJECT") ?> 2:</td>
	<td width="60%"><input type="text" name="rem2_subject" value="<?= htmlspecialcharsbx($arCurrentValues["rem2_subject"]) ?>" size="50" /></td>
</tr>
<tr>
	<td align="right" width="40%"><?= GetMessage("BPAA_NOTIFY_TEXT") ?> 2:</td>
	<td width="60%"><textarea name="rem2_text" rows="3" cols="50"><?= htmlspecialcharsbx($arCurrentValues["rem2_text"]) ?></textarea></td>
</tr>
<tr>
	<td align="right" width="40%">Напоминание 3 (часов):</td>
	<td width="60%"><input type="text" name="rem3_hours" value="<?= htmlspecialcharsbx($arCurrentValues["rem3_hours"]) ?>" size="10" /></td>
</tr>
<tr>
	<td align="right" width="40%"><?= GetMessage("BPAA_NOTIFY_SUBJECT") ?> 3:</td>
	<td width="60%"><input type="text" name="rem3_subject" value="<?= htmlspecialcharsbx($arCurrentValues["rem3_subject"]) ?>" size="50" /></td>
</tr>
<tr>
	<td align="right" width="40%"><?= GetMessage("BPAA_NOTIFY_TEXT") ?> 3:</td>
	<td width="60%"><textarea name="rem3_text" rows="3" cols="50"><?= htmlspecialcharsbx($arCurrentValues["rem3_text"]) ?></textarea></td>
</tr>
<tr>
...
<tr>
  <td align="right"><?= GetMessage("BPAR_PD_TASK_BUTTON3_MESSAGE") ?>:</td>
  <td><?= CBPDocument::ShowParameterField("string", "task_button3_message", $arCurrentValues["task_button3_message"], array("size"=>"50")) ?></td>
</tr>
<!-- НОВАЯ СТРОКА -->
<tr>
	<td align="right"><?= GetMessage("BPAR_PD_REFINE_ALLOWED") ?>:</td>
	<td>
		<select name="refine_allowed">
			<option value="Y"<?= $arCurrentValues["refine_allowed"] != "N" ? " selected" : "" ?>><?= GetMessage("BPAA_PD_YES") ?></option>
			<option value="N"<?= $arCurrentValues["refine_allowed"] == "N" ? " selected" : "" ?>><?= GetMessage("BPAA_PD_NO") ?></option>
		</select>
	</td>
</tr>
<tr>
...
<?php
// Save NotifyText into properties
if (is_array($arCurrentValues))
{
    $arProperties["NotifyText"] = (string)$arCurrentValues["notify_text"];
}
?>